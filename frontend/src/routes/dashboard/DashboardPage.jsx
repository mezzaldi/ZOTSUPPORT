      ...
      >
        <Box sx={modalStyle}>
          ...
          <Typography id="modal-modal-description" variant="body1">
            Enter a UC Irvine email address (ends in “@uci.edu”) to add a new
            administrator to this learning support program:
          </Typography>
          <TextField
            id="outlined-basic"
            label="Email"
...
function RemoveAdminModal() {
  ...
  return (
    <React.Fragment>
      <Button onClick={handleOpenRemoveAdmin} variant="text" color="error">
        Remove admins
      </Button>
      ...
      >
        <Box sx={modalStyle}>
          ...
          <Typography id="modal-modal-description" variant="body1">
            Select an administrator to revoke their administrator permissions
            from this learning support program:
          </Typography>
          <TextField
            id="outlined-basic"
            label="Email"
