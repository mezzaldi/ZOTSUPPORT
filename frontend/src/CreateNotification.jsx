  ...
  return (
    <div className='h2Container'>
      ...
      <Grid container align-items='center' paddingBottom='3rem' columnSpacing = {2} rowSpacing = {6}>
        ...
        <Grid item xs = {9}>
          <TextField required fullWidth label="Title" type="text" name="title" value={formData.title} onChange={handleInputChange} />
        </Grid>
        ...
        <Grid item xs = {9}>
          <Select className="tagContainer" value={recipientsData.recipients} onChange={handleRecipientsInputChange} options={recipientOptions}></Select>
       </Grid>
        ...
        <Grid item xs = {9}>
          <TextField required fullWidth multiline rows={10} name="contents" value={formData.content} onChange={handleInputChange}/>
        </Grid>
        ...
        <Grid item xs = {9}>
          <Button variant="outlined" component='label'> 
            Upload Image  
            <input type="file" hidden onChange={handleInputChange} value={formData.file}/>
          </Button>      
        </Grid>
      ...
      <Grid container justifyContent="center">
        <Grid item>
          <Button variant="contained" type="submit">Send Custom Notification</Button>
        </Grid>
      </Grid>
